...
public abstract class DNATreeNode {
    ...
    /**
     * Adds a number of indents based on the current level and prints lengths of sequences.
     * 
     * @param level
     *            level value
     */
    public void printLengths(int depth) {
        for (int i = 1; i <= depth; i++) {
            System.out.print("  ");
        }
        printNodeLengths(depth);
    }


    /**
     * Adds a number of indents based on the given level and prints statistical distribution of sequences.
     * 
     * @param level
     *            level value
     */
    public void printStats(int depth) {
        ...
        printNodeStats(depth);
    }


    /**
     * Searches the tree using an instance of SearchResults for getting all the sequences
     * 
     * @param res
     ...
     * @param match flag to be changed to true once a match was found.
     * @param res
     *            instance of SearchResults containing 
     */
    public void search(
        int depth,
        char[] sequence,
