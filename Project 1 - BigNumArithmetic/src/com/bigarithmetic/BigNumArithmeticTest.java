...
public class BigNumArithmeticTest extends TestCase {
    ...
    public void testOperationIsValid() {
        ...
        assertFalse(rpn.operationIsValid(operationLine3)); // return false when operators > operands
        
        assertTrue(rpn.operationIsValid(operationLineSum)); // testing only addition
        assertTrue(rpn.operationIsValid(operationLineMulti)); // testing only multiplication
        assertTrue(rpn.operationIsValid(operationLinePow)); // testing only power
    ...
    public void testAdd() {
        ...
        assertTrue(rpn.add(num1, num2).equals(expectedRes1)); // when num1 is larger in digits
        assertTrue(rpn.add(num1, num4).equals(expectedRes2)); // when num4 is larger in digits
