...
public class BigNumArithmetic {
	...
	/**
	 * Returns integer form of SinglyLinkedList object. This method is only used
	 * when we are sure linkedListNum can be held in a 32-bit integer.
	 * 
	 * @param linkedListNum linked list object from which integer form is going to
	 *                      be obtained.
	 ...
	 * 
	 * @param num1 first operand to be added.
	 * @param num2 second operand to be added.
	 * @return result of the addition of num1 and num2.
	 */
	public static SinglyLinkedList<Integer> add(SinglyLinkedList<Integer> num1, SinglyLinkedList<Integer> num2) {
	 ...
	 * returns the product.
	 * 
	 * @param num1 first operand to be multiplied. (Multiplicand).
	 * @param num2 second operand to be multiplied. (Multiplier).
	 * @return the product of num1 and num2.
	 */
	public static SinglyLinkedList<Integer> multiply(SinglyLinkedList<Integer> num1, SinglyLinkedList<Integer> num2) {
		SinglyLinkedList<Integer>.ListNode<Integer> currN1 = num1.getHead();
		SinglyLinkedList<Integer>.ListNode<Integer> currN2 = num2.getHead();
	 ...
	 * 
	 * @param currToken token to be casted to a Singly Linked List.
	 ...
	 * 
	 * @param operationArray operation line segmented in an array of String values.
	 ...
	 * 
	 * @param num1 base of the calculation.
	 * @param num2 exponent of the calculation.
	 * @return result of performing exponentiation
	 */
	public static SinglyLinkedList<Integer> pow(SinglyLinkedList<Integer> num1, SinglyLinkedList<Integer> num2) {
	 ...
	 * 
	 * @param operationLine operation line segmented in an array of String values.
	 * @return intended operation with or without result, based on if it is valid or
	 *         not, respectively.
	 */
	public static String calculateLine(String[] operationLine) {
		...
		Stack<SinglyLinkedList<Integer>> numsStack = new Stack<SinglyLinkedList<Integer>>();
		String resultPrint = "";
	 ...
	 * the main method
	 * 
	 * @param args string to be scanned
	 */
