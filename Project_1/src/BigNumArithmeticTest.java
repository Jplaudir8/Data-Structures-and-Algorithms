...
public class BigNumArithmeticTest extends TestCase {
	...
	/**
	 * Initializes empty list, lists with a small number of items, and list with a
	...
	public void testOperationIsValid() {
		String[] operationLine1 = { "000000056669777", "99999911111", "+", "352324012", "+", "03", "^", "555557778",
				"*" };
		String[] operationLine2 = { "*", "00069777", "99999911111", "+", "352324012" };
		String[] operationLine3 = { "000000056669777", "99999911111", "+", "352324012", "+", "03", "^", "555557778",
				"*", "^" };

		String[] operationLineSum = { "00005666", "99977111", "+", "3557022", "+" };
		String[] operationLineMulti = { "000002340", "224576", "*", "354783", "*", "904856", "*" };
		String[] operationLinePow = { "000002340", "26", "^", "354783", "^", "904856", "^" };

		String[] operationLineSumFail = { "00005666", "+", "3557022", "+" };
		String[] operationLineMultiFail = { "000002340", "*", "354783", "*", "904856", "*" };
		String[] operationLinePowFail = { "000002340", "^", "354783", "^", "904856", "^" };

		String[] operationLineSumMulti = { "000000056669777", "99999911111", "+", "352324012", "+", "03", "*" };
		String[] operationLineSumPow = { "000000056669777", "99999911111", "+", "352324012", "+", "03", "^" };
		String[] operationLinePowMulti = { "000000056669777", "03", "^", "555557778", "*" };

		String[] operationLineSumMultiFail = { "000000056669777", "99999911111", "+", "+", "03", "*" };
		String[] operationLineSumPowFail = { "000000056669777", "99999911111", "+", "+", "03", "^" };
		...
		assertFalse(BigNumArithmetic.operationIsValid(operationLineSumMultiFail));
		assertFalse(BigNumArithmetic.operationIsValid(operationLineSumPowFail));
		assertFalse(BigNumArithmetic.operationIsValid(operationLinePowMultiFail));
	 ...
	 */
	public void testAdd() {
		SinglyLinkedList<Integer> expectedRes1 = new SinglyLinkedList<Integer>();
		SinglyLinkedList<Integer> expectedRes2 = new SinglyLinkedList<Integer>();
	...
	public void testSimpleAddition() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLineSum), "102232 7526 + = 109758");

	}

	/**
	 * Tests a series of complex addition expressions, adding 2 or more numbers at a
	 * time. This test includes numbers whose digits add up to 10 or more, causing
	 * carry-overs
	 */
	public void testComplexAddition() {
		String[] operationLineSum = { "102232", "7526", "+", "99678", "+" };
		assertEquals(BigNumArithmetic.calculateLine(operationLineSum), "102232 7526 + 99678 + = 209436");
	}
	...
	public void testSimpleExponentiation() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLineExp1), "20 11 ^ = 204800000000000");
		assertEquals(BigNumArithmetic.calculateLine(operationLineExp2), "20 10 ^ = 10240000000000");
	}

	/**
	 * Tests a series of compound exponentiation expressions. Note that this test
	 * may time out if you don't follow the algorithm described in the project spec.
	 */
	public void testComplexExponentiation() {
		String[] operationLineExp = { "9", "6", "^", "2", "^" };
		assertEquals(BigNumArithmetic.calculateLine(operationLineExp), "9 6 ^ 2 ^ = 282429536481");
	}
	...
	public void testSimpleMultiplication() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLineMulti), "105998 9586 * = 1016096828");
	}

	/**
	 * Tests a series of complex multiplication expressions. Expressions contain 2
	 * or numbers, and results may be large.
	 */
	public void testComplexMultiplication() {
		String[] operationLineMulti = { "10598", "9586", "*", "455", "*", "800", "*" };
		assertEquals(BigNumArithmetic.calculateLine(operationLineMulti), "10598 9586 * 455 * 800 * = 36979643792000");
	}
	...
	public void testSimpleExpressions() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLineExp), "2 10 * 7 + 10 ^ = 205891132094649");
	}

	/**
	 * When an expression has too many operators and not enough operands, print out
	 * the expression and leave the answer blank.
	 */
	public void testInvalidExpressions() {
		String[] operationLineExp = { "2", "10", "*", "7", "+", "10", "^", "*" };
		assertEquals(BigNumArithmetic.calculateLine(operationLineExp), "2 10 * 7 + 10 ^ * =");
	}
	...
	public void testLeadingZeroesOnZero() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLine1), "0 255 + = 255");
		assertEquals(BigNumArithmetic.calculateLine(operationLine2), "40 255 + = 295");
		assertEquals(BigNumArithmetic.calculateLine(operationLine3), "4 255 + = 259");
		assertEquals(BigNumArithmetic.calculateLine(operationLine4), " 255 + = 255");
		assertEquals(BigNumArithmetic.calculateLine(operationLine5), "5 255 / =");
	...
	public void testSumAndMultiply() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLine1), "0 255 + 45 * = 11475");
	}
	...
	public void testSumAndExponent() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLine1), "8 3 ^ 10 + = 522");
	}
	...
	public void testMultiplyAndExponent() {
		...
		assertEquals(BigNumArithmetic.calculateLine(operationLine1), "10 5 * 2 ^ = 2500");
	}
	...
	public void testScanFileValid() {
		...
		assertFuzzyEquals(systemOut().getHistory(), "40 255 + = 295\n20 30 * = 600");
	}
