...
public class SinglyLinkedList<T> {
	...
	/**
	 * Represents a node in a singly linked list. This node stores data along with
	...
	public class ListNode<T> {
		 ...
		 * 
		 * @param next instance of next ListNode
		 */
	 ...
	 * 
	 * @param newVal first value to be added to this new singly linked list.
	 */
	 ...
	 * 
	 * @param newVal value to be added to beginning of this singly linked list.
	 */
	 ...
	 * 
	 * @param newVal value to be added to the end of this singly linked list.
	 */
	...
	public String toString() {
		...
		ListNode<Integer> currNode = (SinglyLinkedList<T>.ListNode<Integer>) this.head;
		while (currNode != null) {
